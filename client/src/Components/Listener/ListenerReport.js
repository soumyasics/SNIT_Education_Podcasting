...
function ListenerReport() {
  ...
  const sc = async (ansid) => {
    const scor = await axiosInstance.post(
      "/calcScore/" + ansid
    );
          ...
          <div className="col-5 listener-report-divbox mt-3">
            <div className="row">
              ...
              <div className="col-5 pt-5">
                <h6>{select ? score : 'please select a podcast to see the score'}</h6>
                <h6 className="pt-3">10</h6>
                <h6 className="pt-3">{score/10}%</h6>
              </div>
            </div>
          </div>
        </div>
              ...
              (_, i) =>
                questionSet[`question${i + 1}`] && (
                  <div key={i} className="mb-4">
                    <h5>Question {i + 1}</h5>
                    <p className="mt-4">{questionSet[`question${i + 1}`]}</p>
                    <div
                      className={
                        ans[questionSet._id] &&
                        ans[questionSet._id].answerOption1 &&
                        ans[questionSet._id].answerOption1 === "A"
                    ...
                    <div
                      className={
                        ans[questionSet._id] &&
                        ans[questionSet._id].answerOption1 &&
                        ans[questionSet._id].answerOption1 === "B"
                    ...
                    <div
                      className={
                        ans[questionSet._id] &&
                        ans[questionSet._id].answerOption1 &&
                        ans[questionSet._id].answerOption1 === "C"
                    ...
                    <div
                      className={
                        ans[questionSet._id] &&
                        ans[questionSet._id].answerOption1 &&
                        ans[questionSet._id].answerOption1 === "D"
